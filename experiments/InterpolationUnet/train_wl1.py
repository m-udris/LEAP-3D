...
def train():
    ...
    hparams = {
        ...
        'tags': ['UNET', '2D', 'interpolation', 'wl1_loss', 'max_temp+300'],
        'force_prepare': False,
        'is_3d': False,
    ...
    wandb_config = {
        ...
        'name': f'interpolation_unet_2d_wl1_loss_b{hparams["batch_size"]}',
    ...
    callbacks = [
        get_checkpoint_only_last_epoch_callback(checkpoint_filename, monitor='val_loss', mode='min', filename='unet_wl1')
    ]
