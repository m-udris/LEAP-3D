...
def train():
    dataset_dir = Path(sys.argv[1]) if len(sys.argv) > 1 else DATASET_DIR / 'unet_interpolation_offset_coordinates'
    ...
    hparams = {
        ...
        'tags': ['UNET', '2D', 'interpolation', 'l1_loss', 'offset', 'coords'],
        'force_prepare': False,
        'is_3d': False,
    ...
    wandb_config = {
        ...
        'name': f'unet_offset_{hparams["loss_function"]}_coords_L{hparams["positional_encoding_L"]}',
