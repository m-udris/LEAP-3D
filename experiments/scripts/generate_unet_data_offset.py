...
if __name__ == '__main__':
    ...
    generate_cases(DATASET_DIR / 'unet_interpolation_offset', train_cases + test_cases, force_prepare=True)
    aggregate_datasets(DATASET_DIR / 'unet_interpolation_offset', train_cases, is_test=False)
    aggregate_datasets(DATASET_DIR / 'unet_interpolation_offset', test_cases, is_test=True)
