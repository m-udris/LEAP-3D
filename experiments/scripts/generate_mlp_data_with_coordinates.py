...
if __name__ == '__main__':
    ...
    test_cases = [18, 19]
    generate_cases(DATASET_DIR / 'mlp_interpolation_no_distances', train_cases + test_cases, force_prepare=False)
    aggregate_datasets(DATASET_DIR / 'mlp_interpolation_no_distances', train_cases, is_test=False)
    aggregate_datasets(DATASET_DIR / 'mlp_interpolation_no_distances', test_cases, is_test=True)
