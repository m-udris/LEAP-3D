...
def train_unet2d_param_window_normalized(experiment_name='unet2d_param_window_10_normalized_eval_train', window_size=10, window_step_size=10, max_epochs=100, *args, **kwargs):
    train(
