...
def train_unet2d_normalized(experiment_name='unet2d_normalized', lr=1e-3):
    hparams = {
        'batch_size': 256,
        'learning_rate': lr,
        'num_workers': 1,
    ...
    normalize_temperature = lambda x: normalize_temperature_2d(x, MELTING_POINT, base_temperature=BASE_TEMPERATURE, inplace=True)
