...
def train_unet2d_param_window_normalized(experiment_name='unet2d_param_window_5_normalized_100_epochs', window_size=5, window_step_size=5, max_epochs=100, *args, **kwargs):
    train(
