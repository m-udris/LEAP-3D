...
def train():
    ...
    hparams = {
        ...
        'tags': ['MLP', '2D', 'interpolation', 'l1_loss', 'offset'],
        'force_prepare': False,
        'is_3d': False,
    ...
    wandb_config = {
        ...
        'name': f'interpolation_mlp_2d_l1_loss_small_with_highres_b{hparams["batch_size"]}_offset',
    ...
    callbacks = [
        get_checkpoint_only_last_epoch_callback(checkpoint_filename, monitor='val_loss', mode='min', filename='mlp_l1_offset')
    ]
