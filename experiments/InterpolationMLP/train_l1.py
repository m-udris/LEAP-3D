...
def train():
    dataset_dir = Path(sys.argv[1]) if len(sys.argv) > 1 else DATASET_DIR / 'mlp_interpolation'
    ...
    hparams = {
        ...
        'tags': ['MLP', '2D', 'interpolation', 'l1_loss'],
        'force_prepare': False,
        'is_3d': False,
    ...
    wandb_config = {
        ...
        'name': f'interpolation_mlp_2d_l1_loss_b{hparams["batch_size"]}',
