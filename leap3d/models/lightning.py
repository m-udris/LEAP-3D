...
class InterpolationMLP(BaseModel):
    def __init__(self, input_shape=[32,32], extra_params_number=3, input_dimension=1, output_dimension=1, n_conv=16, depth=4, hidden_layers=[1024, 2048, 5096], activation=nn.LeakyReLU, bias=False, *args, **kwargs):
